...
- (void) layoutSubviews
{
    ...
    CGRect rect1 = CGRectMake(0.0, 0.0, self.contentView.frame.size.width - 40.0, 150.0);
...
- (void) applyDefaults
{
    ...
    self.titlePositionY  = 280.0f;
    self.descPositionY   = 260.0f;
    self.titleFont = [UIFont fontWithName:@"HelveticaNeue-Bold" size:16.0];
    self.titleColor = [UIColor whiteColor];
    self.descFont = [UIFont fontWithName:@"HelveticaNeue" size:14.0];
